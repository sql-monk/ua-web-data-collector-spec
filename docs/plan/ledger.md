...
| WP-04 | card ready 2026-09-24; PR1 `wp/04-1-segmenter-tm` ready for PR (testing pass, code review approve + R-1—R-10 fixed, spec review accept, docs done); PR2 ← PR1 + WP-01C PR2 + WP-01A PR3a/3b + WP-01D PR1c + WP-00 PR5 + WP-02 PR2; PR3 ← PR2 | 1,589 translation tests; ADR-0009; dependency `WP-04-to-WP-01C.md` (`untranslated_content`) до PR2; мови поза 16 перекладаються (рішення користувача); batch GCS — out of scope v1 |
