...
| WP-00 | PR3 web scaffold | `wp/00-3-web-scaffold` | testing | реалізація: `reports/WP-00/implementation-pr3.md`; 17 containers healthy; 594 tests | React 19 + Vite 7; nginx-unprivileged |
