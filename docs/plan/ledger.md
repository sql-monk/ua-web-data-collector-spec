...
| WP-02 | PR1 merged `3a416b4` (PR #11); PR2 merged `76473d4` (PR #17, CI green 8/8); PR3 ready | PR2: verified S3/raw claims, FetchHandler, robots TTL/policy, counters, 3893 local tests; CR-1 fail-closed robots fixed; ADR-0011/0012; D-2 conditions 1–2 closed, condition 3 (`parser_version`) → WP-05 |
