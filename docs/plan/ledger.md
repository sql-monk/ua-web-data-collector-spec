...
| `WP-01A-to-WP-01D.md` | WP-01A PR2/PR3a | WP-01D/WP-01B | §1–§6 resolved; §7 PostgreSQL N-2 merged у PR #12, повне resolved після publisher loop WP-01B PR3; §8 defer/not-before/fencing API merged для WP-01D PR1c |
