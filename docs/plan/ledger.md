...
| WP-00 | PR2 docker/compose | `wp/00-2-docker-compose` | code_review + security_review | тестування pass + H-1 mongo boot race: `reports/WP-00/testing-pr2.md`; 210 tests | worktree `.worktrees/wp-00-2` |
