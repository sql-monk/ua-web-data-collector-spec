...
| WP-02 | card ready 2026-09-24; PR1 `wp/02-1-http-ssrf-limits` ready for PR (testing pass, code review approve after CR-1/CR-2 fixes, security approve, spec review accept, docs done); PR2 ← PR1 + WP-01A PR3a + WP-01D PR1c + WP-00 PR5; PR3 ← PR2 | 392 unit/security + 9 PG integration; HTTPX ADR-0008; S3-клієнт `src/collector/storage/**` owner WP-02; D-2 умова 3 (`parser_version`) → WP-05 |
